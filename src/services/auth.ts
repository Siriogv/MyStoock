...
const mockUsers: Record<string, User> = {
  ...
  "2": { id: "2", name: "Operator 1", email: "operator1@example.com", role: "operator" },
  "3": { id: "3", name: "Admin 1", email: "admin1@example.com", role: "administrator" },
};
...
export const authorize = (userRole: UserRole, requiredRole: UserRole): boolean => {
  // Check if the user has the required role
  return userRole === requiredRole ||
         (userRole === 'administrator'); // Admins have all permissions
};
